  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-[100rem] mx-auto px-4 xs:px-5 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 py-10 xs:py-12 sm:py-16 lg:py-20">
        <motion.div
          className="rounded-2xl sm:rounded-3xl md:rounded-[3rem] border border-white/10 bg-slate-950/80 p-4 xs:p-5 sm:p-6 md:p-8 lg:p-10 text-center max-w-4xl mx-auto"
        ...
        >
          ...
          <h2 className="mt-2 sm:mt-3 font-display text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white">
          ...
          <div className="mt-5 xs:mt-6 sm:mt-8 flex justify-center px-4 xs:px-0">
