...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 w-full max-w-[100rem] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 py-16 lg:py-20">
        <div className="max-w-4xl">
          ...
          <motion.p
            className="mt-4 font-body text-brand-200 text-xl sm:text-2xl md:text-3xl uppercase tracking-[0.2em]"
          ...
          <motion.p
            className="mt-6 text-slate-200 text-xl sm:text-2xl max-w-2xl leading-relaxed"
          ...
          >
            ...
            <a
              href="#suites"
              className="inline-flex items-center gap-2.5 font-body text-lg sm:text-xl font-semibold text-white/95 transition hover:text-white focus:outline-none focus:ring-2 focus:ring-brand-400 focus:ring-offset-2 focus:ring-offset-slate-950 group py-2"
            >
              View Suites
              <span className="text-xl sm:text-2xl transition-transform group-hover:translate-x-0.5" aria-hidden>→</span>
            </a>
          </motion.div>
          ...
          >
            <div className="rounded-xl border border-white/10 bg-slate-900/50 backdrop-blur-sm px-5 py-4 sm:px-6 sm:py-5">
